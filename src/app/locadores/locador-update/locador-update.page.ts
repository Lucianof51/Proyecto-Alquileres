...
export class LocadorUpdatePage implements OnInit {
  ...
  constructor(private homeService: HomeService, private activatedRoute: ActivatedRoute, private locadorService: LocadoresService, private router: Router, private alertCtrl: AlertController, private formBuilder: FormBuilder) { }
  id2: any;
  nombre2: any;
  apellido2: any;
  DNI2: any;
